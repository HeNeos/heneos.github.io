...
&+ (\varphi(p^2)-\varphi(p)\varphi(p)) + (\varphi(2p^2) - \varphi(p)\varphi(2p)) + \ldots + (\varphi(p\cdot p \cdot \lfloor m/p\rfloor)-\varphi(p)\varphi(p\cdot \lfloor m/p\rfloor))\cr
...
&+ (\varphi(p^{k+1})-\varphi(p^{k})\varphi(p)) + (\varphi(2p^{k+1}) - \varphi(p^{k})\varphi(2p)) + \ldots + (\varphi(p^{k}\cdot p \cdot \lfloor m/p\rfloor)-\varphi(p^{k})\varphi(p\cdot \lfloor m/p\rfloor))\cr
